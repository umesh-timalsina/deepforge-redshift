...
conv2d = Conv2D(filters=64, kernel_size=(5, 5), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d2 = Conv2D(filters=48, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_2, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d3 = Conv2D(filters=64, kernel_size=(3, 3), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_3, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d4 = Conv2D(filters=48, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_4, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d5 = Conv2D(filters=64, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_5, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d6 = Conv2D(filters=48, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_6, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d7 = Conv2D(filters=64, kernel_size=(5, 5), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_7, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d8 = Conv2D(filters=64, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_8, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
conv2d_output8 = conv2d8(inputs=concatenate_output)
conv2d9 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="valid", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_9, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
conv2d_output9 = conv2d9(inputs=concatenate_output)
conv2d10 = Conv2D(filters=64, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_10, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d11 = Conv2D(filters=92, kernel_size=(5, 5), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_11, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d12 = Conv2D(filters=64, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_12, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d13 = Conv2D(filters=92, kernel_size=(3, 3), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_13, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d14 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_14, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d15 = Conv2D(filters=128, kernel_size=(5, 5), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_15, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d16 = Conv2D(filters=128, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_16, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d17 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_17, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d18 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_18, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d19 = Conv2D(filters=128, kernel_size=(3, 3), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_19, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d20 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_20, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d21 = Conv2D(filters=128, kernel_size=(3, 3), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_21, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d22 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_22, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d23 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_23, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d24 = Conv2D(filters=128, kernel_size=(5, 5), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_24, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d25 = Conv2D(filters=128, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_25, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d26 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_26, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d27 = Conv2D(filters=92, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_27, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d28 = Conv2D(filters=128, kernel_size=(3, 3), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_28, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
conv2d29 = Conv2D(filters=128, kernel_size=(1, 1), strides=(1, 1), padding="same", data_format=None, dilation_rate=(1, 1), groups=1, activation=custom_linear_29, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
dense = Dense(units=1096, activation=custom_linear_30, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
dense2 = Dense(units=1096, activation=custom_linear_31, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
...
dense3 = Dense(units=180, activation=custom_softmax_axis__1, use_bias=True, kernel_initializer=keras.initializers.GlorotUniform(seed=32), bias_initializer=keras.initializers.Zeros())
